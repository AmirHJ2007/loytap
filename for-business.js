...
(function () {
  ...
  var FB_STRINGS = {
    en: {
      ...
      FB_FAQ_A12: "Yes. Everything travels over HTTPS and is stored on our own server. We do not sell, share or rent your customer list to anyone, and no other café using Reloy can see it. Your customers' data belongs to your café, and you can ask us to export or delete it at any time.",
      ...
      FB_INS3_USE: "<span class=\"ins__use-tag\">Use it to</span> retire the prize nobody claims and put the one they do on the front of the card. A reward that is earned and never used costs you nothing, but it brings nobody back either.",
